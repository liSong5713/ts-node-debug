...
const { allowJs = false, preferTs = false, execCheck = false, compilationId = '', compiledDir = '', readyFile = '', } = opts;
const timeThreshold = 0;
const ignore = [/node_modules/];
const sourceMapSupportPath = path.join(path.resolve('./node_modules/source-map-support'), 'source-map-support.js');
